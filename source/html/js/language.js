...
// 버튼 이벤트
document.getElementById("btn_english").addEventListener("click", (e) => {
    render("en");
});
document.getElementById("btn_korean").addEventListener("click", (e) => {
    render("ko");
});
